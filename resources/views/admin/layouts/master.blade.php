...
<head>
    ...
    <!-- Favicons-->
    <link rel="icon" href="templates/demo.geekslabs.com/materialize/v2.1/layout03/images/favicon/favicon-32x32.png" sizes="32x32">
    <!-- Favicons-->
    <link rel="apple-touch-icon-precomposed" href="templates/demo.geekslabs.com/materialize/v2.1/layout03/images/favicon/apple-touch-icon-152x152.png">
    <!-- For iPhone -->
    ...
    <!-- CORE CSS-->
    <link href="templates/demo.geekslabs.com/materialize/v2.1/layout03/css/materialize.css" type="text/css" rel="stylesheet" media="screen,projection">
    <link href="templates/demo.geekslabs.com/materialize/v2.1/layout03/css/style.css" type="text/css" rel="stylesheet" media="screen,projection">
    <!-- Custome CSS-->
    <link href="templates/demo.geekslabs.com/materialize/v2.1/layout03/css/custom-style.css" type="text/css" rel="stylesheet" media="screen,projection">
    <!-- CSS style Horizontal Nav (Layout 03)-->
    <link href="templates/demo.geekslabs.com/materialize/v2.1/layout03/css/style-horizontal.css" type="text/css" rel="stylesheet" media="screen,projection">



    <!-- INCLUDED PLUGIN CSS ON THIS PAGE -->
    <link href="templates/demo.geekslabs.com/materialize/v2.1/layout03/js/plugins/perfect-scrollbar/perfect-scrollbar.css" type="text/css" rel="stylesheet" media="screen,projection">
    <link href="templates/demo.geekslabs.com/materialize/v2.1/layout03/js/plugins/jvectormap/jquery-jvectormap.css" type="text/css" rel="stylesheet" media="screen,projection">
    <link href="templates/demo.geekslabs.com/materialize/v2.1/layout03/js/plugins/chartist-js/chartist.min.css" type="text/css" rel="stylesheet" media="screen,projection">
        ...
        <nav class="cyan">
            <div class="nav-wrapper">
                ...
                <ul class="left">
                    ...
                    <li><h1 class="logo-wrapper"><a href="index.html" class="brand-logo darken-1"><img src="templates/demo.geekslabs.com/materialize/v2.1/layout03/images/materialize-logo.png" alt="materialize logo"></a> <span class="logo-text">Materialize</span></h1></li>
                </ul>
                ...
                <li class="user-details cyan darken-2">
                    <div class="row">
                        <div class="col col s4 m4 l4">
                            <img src="templates/demo.geekslabs.com/materialize/v2.1/layout03/images/avatar.jpg" alt="" class="circle responsive-img valign profile-image">
                        </div>
                        ...
                        <div class="col s12 m6 l4">
                            <div id="profile-card" class="card">
                                <div class="card-image waves-effect waves-block waves-light">
                                    <img class="activator" src="templates/demo.geekslabs.com/materialize/v2.1/layout03/images/user-bg.jpg" alt="user background">
                                </div>
                                <div class="card-content">
                                    <img src="templates/demo.geekslabs.com/materialize/v2.1/layout03/images/avatar.jpg" alt="" class="circle responsive-img activator card-profile-image">
                    ...
                    <div class="row">
                        ...
                        <div class="col s12 m12 l4">
                            <div class="blog-card" >
                                <div class="card">
                                    <div class="card-image waves-effect waves-block waves-light">
                                        <img src="templates/demo.geekslabs.com/materialize/v2.1/layout03/images/gallary/30.jpg" alt="blog-img">
                                    </div>
                            ...
                            <div class="product-card">
                                <div class="card">
                                    <div class="card-image waves-effect waves-block waves-light">
                                        ...
                                        <img src="templates/demo.geekslabs.com/materialize/v2.1/layout03/images/gallary/33.jpg" alt="product-img">
                                    </div>
                                    <ul class="card-action-buttons">
                                    ...
                                    <div class="card-content">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col s4 no-padding">
                                                <a href=""></a><img src="templates/demo.geekslabs.com/materialize/v2.1/layout03/images/amazon.jpg" alt="amazon" class="responsive-img">
                        ...
                        <li>
                            ...
                            <div class="collapsible-body favorite-associates">
                                <div class="favorite-associate-list chat-out-list row">
                                    <div class="col s4"><img src="templates/demo.geekslabs.com/materialize/v2.1/layout03/images/avatar.jpg" alt="" class="circle responsive-img online-user valign profile-image">
                                    </div>
                                    <div class="col s8">
                                        <p>Eileen Sideways</p>
                                ...
                                <div class="favorite-associate-list chat-out-list row">
                                    <div class="col s4"><img src="templates/demo.geekslabs.com/materialize/v2.1/layout03/images/avatar.jpg" alt="" class="circle responsive-img offline-user valign profile-image">
                                    </div>
                                    <div class="col s8">
                                        <p>Renov Leongal</p>
...
<!-- jQuery Library -->
<script type="text/javascript" src="templates/demo.geekslabs.com/materialize/v2.1/layout03/js/jquery-1.11.2.min.js"></script>
<!--materialize js-->
<script type="text/javascript" src="templates/demo.geekslabs.com/materialize/v2.1/layout03/js/materialize.js"></script>
<!--scrollbar-->
<script type="text/javascript" src="templates/demo.geekslabs.com/materialize/v2.1/layout03/js/plugins/perfect-scrollbar/perfect-scrollbar.min.js"></script>


<!-- chartist -->
<script type="text/javascript" src="templates/demo.geekslabs.com/materialize/v2.1/layout03/js/plugins/chartist-js/chartist.min.js"></script>

<!-- chartjs -->
<script type="text/javascript" src="templates/demo.geekslabs.com/materialize/v2.1/layout03/js/plugins/chartjs/chart.min.js"></script>
<script type="text/javascript" src="templates/demo.geekslabs.com/materialize/v2.1/layout03/js/plugins/chartjs/chart-script.js"></script>

<!-- sparkline -->
<script type="text/javascript" src="templates/demo.geekslabs.com/materialize/v2.1/layout03/js/plugins/sparkline/jquery.sparkline.min.js"></script>
<script type="text/javascript" src="templates/demo.geekslabs.com/materialize/v2.1/layout03/js/plugins/sparkline/sparkline-script.js"></script>

<!-- google map api -->
<script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAAZnaZBXLqNBRXjd-82km_NO7GUItyKek"></script>

<!--jvectormap-->
<script type="text/javascript" src="templates/demo.geekslabs.com/materialize/v2.1/layout03/js/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js"></script>
<script type="text/javascript" src="templates/demo.geekslabs.com/materialize/v2.1/layout03/js/plugins/jvectormap/jquery-jvectormap-world-mill-en.js"></script>
<script type="text/javascript" src="templates/demo.geekslabs.com/materialize/v2.1/layout03/js/plugins/jvectormap/vectormap-script.js"></script>


<!--plugins.js - Some Specific JS codes for Plugin Settings-->
<script type="text/javascript" src="templates/demo.geekslabs.com/materialize/v2.1/layout03/js/plugins.js"></script>
<!-- Toast Notification -->
